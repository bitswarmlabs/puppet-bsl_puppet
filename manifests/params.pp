class bsl_puppet::params {
  ...
  $hiera_hierarchy = [
    ...
    'private/%{::server_facts.environment}/hieradata/iam/%%{bsl_core::iam_profile_name}',
    'private/%{::server_facts.environment}/hieradata/iam/%%{bsl_core::iam_profile_name}/%{::trusted.certname}',
    'private/%{::server_facts.environment}/hieradata/iam/%%{bsl_core::iam_profile_name}/%{::ec2_tag_profile}',
    'private/%{::server_facts.environment}/hieradata/iam/%%{bsl_core::iam_profile_name}/%{::ec2_tag_role}',
    'private/%{::server_facts.environment}/hieradata/iam/%%{bsl_core::iam_profile_name}/%{::ec2_tag_environment}',
    'environments/core/hieradata/iam/%%{bsl_core::iam_profile_name}/defaults',
    'environments/core/hieradata/common',
    'environments/core/hieradata/nodes/%{::trusted.certname}',
    'environments/core/hieradata/iam/%%{bsl_core::iam_profile_name}',
    'environments/core/hieradata/iam/%%{bsl_core::iam_profile_name}/%{::trusted.certname}',
    'environments/core/hieradata/iam/%%{bsl_core::iam_profile_name}/%{::ec2_tag_profile}',
    'environments/core/hieradata/iam/%%{bsl_core::iam_profile_name}/%{::ec2_tag_role}',
    'environments/core/hieradata/iam/%%{bsl_core::iam_profile_name}/%{::ec2_tag_environment}',
    'environments/core/hieradata/iam/%%{bsl_core::iam_profile_name}/defaults',
    'environments/%{::environment}/hieradata/common',
    'environments/%{::environment}/hieradata/nodes/%{::trusted.certname}',
    'environments/%{::environment}/hieradata/iam/%%{bsl_core::iam_profile_name}',
    'environments/%{::environment}/hieradata/iam/%%{bsl_core::iam_profile_name}/%{::trusted.certname}',
    'environments/%{::environment}/hieradata/iam/%%{bsl_core::iam_profile_name}/%{::ec2_tag_profile}',
    'environments/%{::environment}/hieradata/iam/%%{bsl_core::iam_profile_name}/%{::ec2_tag_role}',
    'environments/%{::environment}/hieradata/iam/%%{bsl_core::iam_profile_name}/%{::ec2_tag_environment}',
    'environments/%{::environment}/hieradata/iam/%%{bsl_core::iam_profile_name}/defaults',
