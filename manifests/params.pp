class bsl_puppet::params {
  ...
  $r10k_webhook_callback_fqdn = inline_template('<%= scope.lookupvar(\'bsl_puppet::config::server_external_fqdn\') %>')
  ...
  $puppetboard_fqdn = inline_template('<%= scope.lookupvar(\'bsl_puppet::config::server_external_fqdn\') %>')
  $puppetboard_port = '80'
